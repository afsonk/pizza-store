    ...
    return (
        <svg width="222" height="144" fill="none">
            ...
            <path
                ...
                fill="#fff" stroke="#000" strokeWidth="0.804" strokeMiterlimit="10" strokeLinecap="round"
            ...
            <path
                ...
                stroke="#000" strokeWidth="0.804" strokeMiterlimit="10" strokeLinecap="round"
                strokeLinejoin="round"></path>
            <path
                ...
                fill="#fff" stroke="#000" strokeWidth="0.804" strokeMiterlimit="10" strokeLinecap="round"
                strokeLinejoin="round"></path>
            <path d="M84.37 80.758c-1.43-2.252-6.011-9.757-5.322-12.459.69-2.702.936-5.704.936-5.704" stroke="#000"
                  strokeWidth="0.804" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
            <path d="M103.484 95.017c.247-1.55.099-3.002-1.823-4.653M107.919 94.716c.197-1.55.296-3.302-2.661-5.253"
                  stroke="#000" strokeWidth="1.1" strokeMiterlimit="10" strokeLinecap="round"
                  strokeLinejoin="round"></path>
            <path
            ...
            <path
                ...
                fill="#fff" stroke="#000" strokeWidth="1.1" strokeMiterlimit="10" strokeLinecap="round"
                strokeLinejoin="round"></path>
            <path
            ...
            <path
                ...
                fill="#000"></path>
            <path d="M159.556 139.997l-13.944 3.002-1.675-2.802 15.619-.2z" fill="#fff"></path>
            <path d="M159.556 139.997l-13.944 3.002-1.675-2.802 15.619-.2z" stroke="#000" strokeWidth="1.1"
                  strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
            <path d="M158.767 86.16l-11.924-62.243 3.843-7.906 53.953 15.511 7.194 14.16 9.066 62.444-62.132-21.966z"
                  fill="#FF6900"></path>
            <path d="M158.767 86.16l-11.924-62.243 3.843-7.906 53.953 15.511 7.194 14.16 9.066 62.444-62.132-21.966z"
                  stroke="#000" strokeWidth="1.1" strokeMiterlimit="10" strokeLinecap="round"
                  strokeLinejoin="round"></path>
            <path d="M158.77 86.16l-3.843 9.106 62.131 21.866 3.942-9.107-62.23-21.865z" fill="#FF6900"></path>
            <path d="M158.77 86.16l-3.843 9.106 62.131 21.866 3.942-9.107-62.23-21.865z" stroke="#000"
                  strokeWidth="1.1" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
            <path d="M213.017 53.938l-3.449 6.704a76.675 76.675 0 00-.493 3.002l6.75 48.735 5.174-4.403-7.982-54.038z"
                  fill="#fff" stroke="#000" strokeWidth="0.804" strokeMiterlimit="10" strokeLinecap="round"
                  strokeLinejoin="round"></path>
            <path d="M213.017 53.938l-3.449 6.704a76.675 76.675 0 00-.493 3.002l6.75 48.735 5.174-4.403-7.982-54.038z"
                  stroke="#000" strokeWidth="1.1" strokeMiterlimit="10" strokeLinecap="round"
                  strokeLinejoin="round"></path>
            <path d="M148.915 34.674l-4.286 2.251c-.444 1-.542 1.801-.986 2.802l7.736 50.686 7.44-4.253-9.904-51.486z"
                  fill="#FF6900"></path>
            <path d="M148.37 31.872l-6.011 3.352c-.444 1-.789 1.701-1.232 2.702l10.248 52.487 7.44-4.253-10.445-54.288z"
                  stroke="#000" strokeWidth="1.1" strokeMiterlimit="10" strokeLinecap="round"
                  strokeLinejoin="round"></path>
            <path
            ...
            <path
                ...
                fill="#FF6900"></path>
            <path d="M95.06 115.13l59.864-19.863 62.132 21.865-57.5 22.866-64.497-24.868z" stroke="#000"
                  strokeWidth="1.1" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
            <path
            ...
            <path
                ...
                stroke="#000" strokeWidth="1.1" strokeMiterlimit="10" strokeLinecap="round"
                strokeLinejoin="round"></path>
            <path d="M145.612 132.292v10.707l-57.007-22.015v-10.757l57.007 22.065z" fill="#fff" stroke="#000"
                  strokeWidth="0.804" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
            <path d="M145.612 132.292v10.707l-57.007-22.015v-10.757l57.007 22.065z" stroke="#000" strokeWidth="1.1"
                  strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
            <path
            ...
            <path
                ...
                fill="#fff" stroke="#000" strokeWidth="1.1" strokeMiterlimit="10" strokeLinecap="round"
                strokeLinejoin="round"></path>
            <path d="M136.25 108.375c.394-.4 3.596-1.901 4.877-1.601" stroke="#000" strokeWidth="1.1"
                  strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
            <path
            ...
            <path
                ...
                fill="#fff" stroke="#000" strokeWidth="1.1" strokeMiterlimit="10" strokeLinecap="round"
                strokeLinejoin="round"></path>
            <path d="M113.143 91.964c.344-.75-.05-4.203-2.415-4.754-.591-.15-1.379-.25-1.379-.25" stroke="#000"
                  strokeWidth="1.1" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
            <path
            ...
            <path
                ...
                stroke="#000" strokeWidth="1.1" strokeMiterlimit="10" strokeLinecap="round"
                strokeLinejoin="round"></path>
            <path d="M95.11 41.277c-1.922-1.951-.69-5.153-2.809-6.804l2.809 6.804z" fill="#fff"></path>
            <path d="M95.11 41.277c-1.922-1.951-.69-5.153-2.809-6.804" stroke="#000" strokeWidth="1.1"
                  strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
        </svg>
    )
}
